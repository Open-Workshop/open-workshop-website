...
class RouteTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_mod_edit_api_exposes_relation_endpoints(self) -> None:
        ...
        self.assertIn('\"merge\": {\"method\": \"POST\", \"path\": \"/tags/merge\"}', app_config)
    ...
    def test_tags_admin_template_exposes_crud_layout(self) -> None:
        ...
        self.assertIn('data-action="tags-merge-duplicates"', template)
        ...
        self.assertNotIn(">Настройки</a>", template)
        ...
        self.assertIn(".tags-admin__merge-button", styles)
        ...
        self.assertIn("tagApi.merge", script)
        ...
        self.assertIn("getDuplicateMergePlan", script)
        self.assertIn("tags-merge-duplicates", script)
